...
<body>
	...
	<div class="container">
		<div class="page-header">
			...
			<hr>
			<h5>List of Students who are approved for the taking online exam</h5>
		</div>
			...
			<table class="table table-hover">
				<thead class="thead-dark">
					<tr>
						...
						<th style="font-size: 20px;"><span class="fa fa-tag"></span> Exam Code</th>
					</tr>
				</thead>
				<tbody>
					<?php
						$disp_stud = "SELECT * FROM exam INNER JOIN users USING(UsersID) ORDER BY UsersID DESC";
						...
						if (mysqli_num_rows($disp_res) > 0) {
							while ($disp_row = mysqli_fetch_assoc($disp_res)) {
								echo "<tr>
									...
									<td class='font-weight-bold text-warning'>".$disp_row['ExamCode']."</td>
								</tr>";
							}
						} else {
